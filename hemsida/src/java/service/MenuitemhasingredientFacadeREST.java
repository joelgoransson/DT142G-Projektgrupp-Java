...
public class MenuitemhasingredientFacadeREST extends AbstractFacade<Menuitemhasingredient> {
    ...
    public void create(Menuitemhasingredient entity) {
        super.create(entity);
    }
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Menuitemhasingredient> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Menuitemhasingredient> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
